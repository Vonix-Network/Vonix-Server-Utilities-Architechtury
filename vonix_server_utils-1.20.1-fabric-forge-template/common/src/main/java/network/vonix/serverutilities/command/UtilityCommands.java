    ...
    private static void registerServerCommands(CommandDispatcher<CommandSourceStack> d) {
        ...
        d.register(Commands.literal("accsee")
                ...
                .then(Commands.argument("target", EntityArgument.player())
                        .executes(ctx -> {
                            if (!(ctx.getSource().getEntity() instanceof ServerPlayer player)) return 0;
                            AccessoryHelper.openAccessoryMenu(EntityArgument.getPlayer(ctx, "target"), player);
                            return 1;
                        })));
    }
                ...
                if (listTag != null) {
                    ...
                    net.minecraft.world.SimpleContainer container = new net.minecraft.world.SimpleContainer(54) {
                        ...
                        public void setChanged() {
                            ...
                            net.minecraft.nbt.CompoundTag t = stack.getOrCreateTag();
                            ...
                            target.getInventory().setItem(slotIndex, stack);
