...
public final class PermissionGate {
    ...
    public static boolean check(CommandSourceStack source, String node, int opFallback) {
        ...
        return source.permissions() instanceof net.minecraft.server.permissions.LevelBasedPermissionSet perms
                && perms.level().isEqualOrHigherThan(net.minecraft.server.permissions.PermissionLevel.byId(opFallback));
    }
