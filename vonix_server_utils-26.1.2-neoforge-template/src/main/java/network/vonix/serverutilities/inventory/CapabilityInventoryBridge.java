...
/**
 * Common facade for {@code /backsee} item-handler inventories. The native
 * NeoForge adapter is installed by the loader entrypoint.
 */
public final class CapabilityInventoryBridge {
    ...
    /**
     * VSU-side handle to a resolved item inventory. No Forge types leak
