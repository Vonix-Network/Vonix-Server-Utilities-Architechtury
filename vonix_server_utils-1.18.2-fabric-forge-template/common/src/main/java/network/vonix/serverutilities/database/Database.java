 ...
 * All public methods must be called from the VonixSU-DB executor thread only â€”
...
public final class Database {
    ...
    // â”€â”€ Migration from VonixCore â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    private void attemptMigration(MinecraftServer server) {
        try {
            ...
            if (oldDb == null) {
                markMigrated();
                VonixServerUtilities.LOGGER.info("[VonixSU] No VonixCore database found â€” skipping migration.");
                return;
            }

            VonixServerUtilities.LOGGER.info(
                    "[VonixSU] Migrating data from VonixCore database at {} â€¦", oldDb.getAbsolutePath());
            ...
            try (Connection src = DriverManager.getConnection("jdbc:sqlite:" + oldDb.getAbsolutePath())) {
                ...
                VonixServerUtilities.LOGGER.info(
                        "[VonixSU] Migration complete â€” {} homes, {} warps, {} kit-cooldowns imported.",
                        homes, warps, kits);
            }
